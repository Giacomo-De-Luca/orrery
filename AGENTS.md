...
- Always update the AGENTS.md both in the main project and in the frontend or backend folder after significant updates. For minor updates or significant refactors, detail them in .md files in the documentation/ folder, and write in AGENTS.md which documentation files contains the documentation. 
...
- **`interpretability_backend/`** — Python backend (FastAPI + Strawberry GraphQL). Has its own `AGENTS.md`.
...
- **`embedding_visualization/`** — Next.js 15 frontend. Has its own `AGENTS.md`.
