...
- :class:`WordNetParser` (scripts/utils/wordnet_parser.py)
- :class:`GemmaPytorchInference` (scripts/inference/gemma_pytorch.py)
- :class:`HookManager` + :class:`SAEConfig` (scripts/sae/)
...
from scripts.sae.hook_manager import HookManager
from scripts.sae.loading import WIDTH_TO_D_SAE
from scripts.utils.wordnet_parser import WordNetParser
...
class ActivationCollector:
    ...
    def run(self) -> Path:
        ...
        from scripts.sae.autointerpreter.config import AutoInterpretConfig
        dump_yaml(
