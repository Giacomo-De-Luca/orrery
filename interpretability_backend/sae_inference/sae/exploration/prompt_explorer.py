...
Usage::
    ...
    from scripts.sae.exploration.prompt_explorer import PromptExplorer, PromptExplorerConfig
...
from scripts.sae.exploration.explore_neuronpedia import ActivationExample, NeuronpediaExplorer
from scripts.sae.feature_labels import FeatureLabelStore
...
class PromptExplorer:
    ...
    def neuronpedia(self) -> NeuronpediaExplorer:
        if self._neuronpedia is None:
            from scripts.sae.feature_labels import _width_as_int
