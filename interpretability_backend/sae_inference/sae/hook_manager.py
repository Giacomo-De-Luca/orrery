...
from scripts.sae.activation_store import ActivationStore
from scripts.sae.loading import load_sae
from scripts.sae.sae_config import HookType, SAEConfig
from scripts.sae.sae_model import JumpReLUSAE
from scripts.sae.steering import (
    ResolvedSteeringOp,
    SteeringOp,
    apply_steering,
    resolve_op,
...
class HookManager:
    ...
    def __init__(self) -> None:
        self._saes: dict[tuple[int, HookType], JumpReLUSAE] = {}
        self._configs: dict[tuple[int, HookType], SAEConfig] = {}
    ...
    def add_sae(self, config: SAEConfig) -> None:
