...
Wraps the reference gemma_pytorch implementation (references/gemma_pytorch/)
...
CLI:
    uv run python -m scripts.inference.gemma_pytorch \\
...
# Add gemma_pytorch reference to import path
_GEMMA_PYTORCH_ROOT = Path(__file__).resolve().parents[1] / "gemma_pytorch"
