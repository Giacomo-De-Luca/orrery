...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@/lib/ui-primitives/tooltip"
...
// Keyboard shortcut removed - handled by parent component (page.tsx)
...
function SidebarProvider({
  ...
  // Keyboard shortcut removed - handled by parent component (page.tsx)
  // to avoid conflicts when multiple sidebars exist
      ...
      >
        <div
          ...
          className={cn(
            ...
            "group-data-[variant=floating]:bg-transparent group-data-[variant=floating]:backdrop-blur"
          )}
        >
          {children}
        </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]: md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        className
      )}
      {...props}
    />
